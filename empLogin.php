...
<div class="loginbox">
    <img src="assets/avatar.png" class="avatar">
        ...
        <form action="handlers/empLoginHandle.php" method="POST">

            <p>Email</p>
            <input type="text" name="empEmail" placeholder="Enter Email Address" >
            <p>Password</p>
            <input type="password" name="empPassword" placeholder="Enter Password" >
